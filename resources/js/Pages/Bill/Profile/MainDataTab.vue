<template>
    <ElContainer>
        <section class="grid md:grid-cols-2 gap-4 text-lg">
            <ElLabelValuePrice :currency="data.row.currency" :value="data.row.purchase_price"
            ...
            <ElLabelValueText :value="data.row.note" :label="$t('column.notes')"/>
        </section>
    </ElContainer>
